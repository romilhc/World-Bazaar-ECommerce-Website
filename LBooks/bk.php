<html>
	...
	<body style="margin:0; background-color:black;">
		...
		<div>
			<div class="bkpg" style="margin-top:4px;">
				<div class="dc1">
					<div class="pic1 dr1" ><div class="text1"><pre>Rs. 299</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic2 dr2"><div class="text2"><pre>Rs. 399</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic3 dr3"><div class="text3"><pre>Rs. 329</pre><button type="button" class="buy">BUY NOW!</button></div></div>
				</div>
				<div class="dc2">
					<div class="pic4 dr4"><div class="text4"><pre>Rs. 469</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic5 dr5"><div class="text5"><pre>Rs. 549</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic6 dr6"><div class="text6"><pre>Rs. 289</pre><button type="button" class="buy">BUY NOW!</button></div></div>
			
				</div>
				<div class="dc3">
					<div class="pic7 dr7"><div class="text7"><pre>Rs. 499</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic8 dr8"><div class="text8"><pre>Rs. 429</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic9 dr9"><div class="text9"><pre>Rs. 579</pre><button type="button" class="buy">BUY NOW!</button></div></div>
			...
			<!--<div class="sidebar">
				<div class="login">
					<form>
						<br><br>
					<center>       Email ID: <input type="text" placeholder="john@dane.com"><br><br>
       ...
       Password: <input type="password" placeholder="password"></center><br>
					...
					<a href="../\Register Page\registerpage.html"><button class="register" type="button">Register Now!</button></a>
				</div>
