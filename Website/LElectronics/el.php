<html>
	...
	<body style="margin:0; background-color:black;">
		...
		<div>
			<div class="elpg" style="margin-top:4px;">
				<div class="dc1">
					<div class="pic1 dr1" ><div class="text1"><pre>Rs. 28999</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic2 dr2"><div class="text2"><pre>Rs. 60500</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic3 dr3"><div class="text3"><pre>Rs. 35999</pre><button type="button" class="buy">BUY NOW!</button></div></div>
				</div>
				<div class="dc2">
					<div class="pic4 dr4"><div class="text4"><pre>Rs. 21990</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic5 dr5"><div class="text5"><pre>Rs. 23666</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic6 dr6"><div class="text6"><pre>Rs. 130000</pre><button type="button" class="buy">BUY NOW!</button></div></div>
			
				</div>
				<div class="dc3">
					<div class="pic7 dr7"><div class="text7"><pre>Rs. 15999</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic8 dr8"><div class="text8"><pre>Rs. 55000</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic9 dr9"><div class="text9"><pre>Rs. 89999</pre><button type="button" class="buy">BUY NOW!</button></div></div>
