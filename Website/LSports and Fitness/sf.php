<html>
	...
	<body style="margin:0; background-color:black;">
		...
		<div>
			<div class="sfpg" style="margin-top:4px;">
				<div class="dc1">
				...
				<div class="dc2">
					<div class="pic4 dr4"><div class="text4"><pre>Rs. 2069</pre><button type="button" class="buy">BUY NOW!</button></div></div>
				...
				<div class="dc3">
					<div class="pic7 dr7"><div class="text7"><pre>Rs. 1999</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic8 dr8"><div class="text8"><pre>Rs. 599</pre><button type="button" class="buy">BUY NOW!</button></div></div>
					<div class="pic9 dr9"><div class="text9"><pre>Rs. 899</pre><button type="button" class="buy">BUY NOW!</button></div></div>
