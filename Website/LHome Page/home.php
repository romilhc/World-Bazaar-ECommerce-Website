		...
		<div>
			...
			<!--<div class="sidebar">
				<div class="login">
					...
					<a href="C:\Users\djsce.student\Desktop\Website\Register Page\registerpage.html"><button class="register" type="button">Register Now!</button></a>
				</div>
